...
export const UserSchema = z.object({
  ...
  can_see_rates: z.boolean(),
  can_create_projects: z.boolean(),
  can_create_invoices: z.boolean(),
  is_active: z.boolean(),
...
export const CreateUserSchema = z.object({
  ...
  can_see_rates: z.boolean().optional().default(false),
  can_create_projects: z.boolean().optional().default(false),
  can_create_invoices: z.boolean().optional().default(false),
